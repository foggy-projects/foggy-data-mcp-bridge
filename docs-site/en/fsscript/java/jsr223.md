...
FSScript implements the Java standard JSR-223 (javax.script) interface, allowing integration with any framework that supports this standard.
...
FSScript's ScriptEngine implements these interfaces:
