...
public class ExportWithEChartsTool implements McpTool {

    private final ExportWithChartExecutor executor;

    @Override
    public String getName() {
        return "dataset.export_with_echarts";
    }
    ...
    public Object execute(Map<String, Object> arguments, ToolExecutionContext context) {
        return executor.execute(arguments, context, "echarts");
    }
    ...
    public Flux<ProgressEvent> executeWithProgress(
        ...
        return executor.executeWithProgress(arguments, context, "echarts");
    }
}
