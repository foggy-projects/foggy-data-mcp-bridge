...
3. [blocked / governance] Do not issue feature acceptance or begin Step 5 until the Step 4-scoped canonical
   candidate advances from `DRAFT` to `READY_FOR_SIGNOFF`. The separate canonical spec is
