...
| 3 | 五数据库与外部集成 required matrix | in-progress | fresh SQLite subset `5/50`；committed Redis + Mongo subsets `6/33`，两组 INT/TERM/HUP cleanup；剩余四库 `24/320`、external `10/43` 与 state negatives pending |
