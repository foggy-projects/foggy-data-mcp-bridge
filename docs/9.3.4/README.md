...
| 3 | 五数据库与外部集成 required matrix | in-progress | fresh SQLite subset `5/50`；committed Redis + Mongo + MySQL subsets `14/56`，三组 INT/TERM/HUP cleanup；剩余四库 `24/320`、Vector `2/20` 与 state negatives pending |
