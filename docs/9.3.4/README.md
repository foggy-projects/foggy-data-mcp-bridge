...
| 5 | 单一 authority runner 与 immutable evidence rehearsal | approved / replacement preflight pending | no-CI r1 remains failed-closed；owner approved one private-full-clone replacement，must pass pre-activation `scan-runtime-source` first |
