...
| `foggy-data-mcp-bridge-wt-dev-compose` | `foggy-dataset-model/src/main/java/com/foggyframework/dataset/db/model/impl/property/DbPropertyImpl.java` | property runtime support | updated | Carries metadata, validates scale contract, and applies declaration scaling for physical and resolved formula columns |
