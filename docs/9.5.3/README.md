...
| [Candidate-query fail-closed guards](workitems/BUG-runtime-candidate-query-fail-closed-guards.md) | ACCEPTED | 已关闭 phase 权限、selected source provenance、backend mode 与 detached cleanup 缺口 |
