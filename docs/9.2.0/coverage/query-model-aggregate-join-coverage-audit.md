...
- Query-cloud/data-viewer consumption of Java V3 JSON metadata for aggregate relation fields remains an upstream metadata-chain check. Core QueryColumn and Java metadata export coverage is now present.
