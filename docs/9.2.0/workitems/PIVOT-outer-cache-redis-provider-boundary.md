...
The default addon test run includes `RedisPivotOuterCacheProviderLiveTest`, `RedisPivotOuterCacheInvalidationLiveTest`, and `PivotOuterCacheRedisInvalidationAutoConfigurationLiveTest` but skips them unless `foggy.redis.live.enabled=true`.
