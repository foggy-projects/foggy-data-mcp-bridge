 ...
 * Demo 测试基类
 *
 * <p>提供 Demo 查询模型的公共测试支持</p>
 *
 * @author foggy-framework
 * @since 1.0.0
 */
@Slf4j
@SpringBootTest(classes = com.foggyframework.dataset.db.model.test.JdbcModelTestApplication.class)
@ActiveProfiles({"sqlite"})
public abstract class DemoTestSupport {
