    ...
    void renderDateDiffRejectsBadArity() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> DialectAwareFunctionExp.renderDateDiff(null,
                        java.util.Collections.singletonList(com.foggyframework.dataset.db.model.engine.expression.SqlFragment.ofLiteral("a"))));
    }
    ...
    void renderNowRejectsNonEmptyArgs() {
        assertThrows(IllegalArgumentException.class,
                () -> DialectAwareFunctionExp.renderNow(null,
                        java.util.Collections.singletonList(com.foggyframework.dataset.db.model.engine.expression.SqlFragment.ofLiteral("x"))));
    }
    ...
    void renderDateAddRejectsNonLiteralUnit() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> DialectAwareFunctionExp.renderDateAdd(null, java.util.Arrays.asList(
                        com.foggyframework.dataset.db.model.engine.expression.SqlFragment.ofLiteral("t.d"),
                        com.foggyframework.dataset.db.model.engine.expression.SqlFragment.ofLiteral("?"),
                        com.foggyframework.dataset.db.model.engine.expression.SqlFragment.ofLiteral("t.unit_col")
                )));
    }
}
