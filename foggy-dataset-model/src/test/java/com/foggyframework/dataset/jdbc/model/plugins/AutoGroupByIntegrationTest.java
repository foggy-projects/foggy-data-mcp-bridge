...
class AutoGroupByIntegrationTest extends EcommerceTestSupport {
    ...
    void testStepRegistration() {
        ...
        com.foggyframework.dataset.jdbc.model.engine.expression.InlineExpressionParser.InlineExpression parsed =
                com.foggyframework.dataset.jdbc.model.engine.expression.InlineExpressionParser.parse(testExpr);
