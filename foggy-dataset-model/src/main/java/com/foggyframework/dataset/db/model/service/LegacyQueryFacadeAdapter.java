...
/**
 * Compatibility adapter for the 9.3.x mutable query request/result types.
 *
 * <p>New consumers should construct the DTO-only public request directly.
 * This adapter exists for one compatibility cycle while existing HTTP and
 * addon request models migrate independently.</p>
 *
 * @since 9.3.5
 */
public final class LegacyQueryFacadeAdapter {
    ...
    private LegacyQueryFacadeAdapter() {
    }
