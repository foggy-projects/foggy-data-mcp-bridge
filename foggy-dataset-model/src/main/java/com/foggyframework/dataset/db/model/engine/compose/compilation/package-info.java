 ...
 * <h2>Public API</h2>
 * <ul>
 *   <li>{@link com.foggyframework.dataset.db.model.engine.compose.compilation.ComposeSqlCompiler}
 *       — single entry-point; {@code QueryPlan} → {@code ComposedSql}.</li>
 *   <li>{@link com.foggyframework.dataset.db.model.engine.compose.compilation.ComposeCompileException}
 *       — structured error type; 4 codes total.</li>
 *   <li>{@link com.foggyframework.dataset.db.model.engine.compose.compilation.ComposeCompileErrorCodes}
