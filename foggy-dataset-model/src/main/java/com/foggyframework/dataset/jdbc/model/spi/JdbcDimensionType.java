...
public enum JdbcDimensionType {
     ...
     */
    public static JdbcDimensionType fromString(String value) {
     ...
     */
    public static JdbcDimensionType fromColumnType(JdbcColumnType columnType) {
        if (columnType == null) {
            return NORMAL;
        }
        switch (columnType) {
