...
EXPECTED_STEP4_RUNTIME_BINDINGS = {
    ...
    "scripts/v934/step4/coverage-contract.json": {
        ...
        "diagnostic": {
            ...
            "sha256": "45dcbe9a951af79775f45a0c6623d81ebe6608548e0d467edda03f57abbb44a9",
        },
        "formal": {
            "contract_status": "formal-ready",
            "publication_status": "formal-ready",
            "sha256": "9d5a29807e44fe79255a273d304dfce22a883b11582f9871e3508e45457ca8dd",
        },
    },
    ...
    "scripts/v934/step4/coverage_tool.py": "93d28c5f9d518fe03b338f2471dcaebba7742446caaaa41c88d06311e43006a5",
    ...
    try:
        if args.command == "validate":
            ...
            print(
                ...
                f"parents=3 contracts=4 amendments={len(EXPECTED_AMENDMENT_PATHS)} "
                "step4_bindings=9 required=45/446 addon=2/6 status=passed"
            )
        else:
