...
CREATE TABLE IF NOT EXISTS public.v934_test_sentinel (
    sentinel_key VARCHAR(64) PRIMARY KEY,
    sentinel_value VARCHAR(64) NOT NULL
);

INSERT INTO public.v934_test_sentinel (sentinel_key, sentinel_value)
