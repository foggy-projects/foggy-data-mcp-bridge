...
('PRM031', N'2025新年大促', N'折扣', 0.88, '2025-01-01', '2025-01-20', 'ACTIVE'),
('PRM032', N'2025春节好礼', N'满减', NULL, '2025-01-28', '2025-02-12', 'ACTIVE'),
('PRM033', N'开工大吉', N'折扣', 0.85, '2025-02-13', '2025-02-28', 'ACTIVE'),
('PRM034', N'38女王节-满500减80', N'满减', NULL, '2025-03-01', '2025-03-08', 'ACTIVE'),
('PRM035', N'五一黄金周', N'折扣', 0.75, '2025-05-01', '2025-05-05', 'ACTIVE'),
('PRM036', N'618全民购物节', N'折扣', 0.70, '2025-06-01', '2025-06-18', 'ACTIVE'),
('PRM037', N'暑期嘉年华', N'折扣', 0.82, '2025-07-01', '2025-08-31', 'ACTIVE'),
('PRM038', N'中秋佳节', N'赠品', NULL, '2025-09-20', '2025-09-29', 'ACTIVE'),
('PRM039', N'十一国庆盛典', N'满减', NULL, '2025-10-01', '2025-10-07', 'ACTIVE'),
('PRM040', N'双11超级购物节', N'折扣', 0.65, '2025-11-01', '2025-11-11', 'ACTIVE'),
('PRM041', N'双12年度收官', N'折扣', 0.68, '2025-12-01', '2025-12-12', 'ACTIVE'),
('PRM042', N'品牌日-智能家电', N'折扣', 0.80, '2025-04-20', '2025-04-22', 'ACTIVE'),
('PRM043', N'限时特惠', N'折扣', 0.60, '2025-01-01', '2025-12-31', 'ACTIVE'),
('PRM044', N'会员尊享月', N'折扣', 0.85, '2025-01-01', '2025-12-31', 'ACTIVE'),
('PRM045', N'新客专享券', N'优惠券', NULL, '2025-01-01', '2025-12-31', 'ACTIVE');
GO
...
WHILE @o <= 2000
BEGIN
    SET @rand_date = DATEADD(DAY, ABS(CHECKSUM(NEWID())) % 1461, '2022-01-01');
...
-- 2025年数据
('T001', 20250101, 55000.00, 6), ('T001', 20250102, 65000.00, 7),
('T002', 20250101, 33000.00, 4), ('T002', 20250102, 38000.00, 5),
('T003', 20250101, 11000.00, 2), ('T003', 20250102, 13500.00, 3),
('T004', 20250101, 9000.00, 1), ('T004', 20250102, 10000.00, 2),
('T005', 20250101, 110000.00, 22), ('T005', 20250102, 130000.00, 28),
('T006', 20250101, 5500.00, 1), ('T006', 20250102, 6500.00, 1),
('T007', 20250101, 7500.00, 1), ('T007', 20250102, 8500.00, 2),
('T008', 20250101, 50000.00, 11), ('T008', 20250102, 60000.00, 13),
...
-- 16. 客户订单生命周期派生数据（首购 cohort / 复购窗口 fixture）
DELETE FROM customer_order_lifecycle
WHERE customer_id IN ('CUS000001', 'CUS000002', 'CUS000003', 'CUS000004');
...
(customer_id, customer_name, first_order_date, first_order_month, first_order_channel, order_count, lifetime_amount,
 repurchase_30d_flag, repurchase_60d_flag, repurchase_90d_flag) VALUES
('CUS000001', N'张三', '2024-01-01', '2024-01', 'ONLINE', 3, 8799.00, 1, 1, 1),
('CUS000002', N'李四', '2024-01-01', '2024-01', 'ONLINE', 1, 2999.00, 0, 0, 0),
('CUS000003', N'王五', '2024-01-02', '2024-01', 'OFFLINE', 2, 1899.00, 1, 1, 1),
('CUS000004', N'赵六', '2024-01-03', '2024-01', 'APP', 1, 1299.00, 0, 0, 0);
GO
...
-- 2025年数据
(20250101, 1, 1, 3, 26997.00, 16200.00),
(20250101, 2, 2, 2, 13998.00, 8400.00),
(20250101, 3, 3, 1, 14999.00, 9000.00),
(20250101, 5, 1, 6, 1794.00, 900.00),
(20250101, 7, 4, 12, 1188.00, 480.00),
(20250101, 9, 5, 4, 1596.00, 800.00),
(20250102, 1, 2, 4, 35996.00, 21600.00),
(20250102, 4, 3, 3, 23997.00, 14400.00),
(20250102, 6, 1, 5, 2495.00, 1250.00),
(20250102, 8, 6, 6, 3594.00, 1800.00),
(20250102, 10, 5, 3, 3897.00, 1950.00),
(20250103, 2, 1, 3, 20997.00, 12600.00),
(20250103, 3, 4, 2, 29998.00, 18000.00),
(20250103, 5, 2, 10, 2990.00, 1500.00),
(20250103, 7, 5, 18, 1782.00, 720.00),
(20250103, 9, 3, 5, 1995.00, 1000.00);
GO
