...
('PRM031', '2025新年大促', '折扣', 0.88, '2025-01-01', '2025-01-20', 'ACTIVE'),
('PRM032', '2025春节好礼', '满减', NULL, '2025-01-28', '2025-02-12', 'ACTIVE'),
('PRM033', '开工大吉', '折扣', 0.85, '2025-02-13', '2025-02-28', 'ACTIVE'),
('PRM034', '38女王节-满500减80', '满减', NULL, '2025-03-01', '2025-03-08', 'ACTIVE'),
('PRM035', '五一黄金周', '折扣', 0.75, '2025-05-01', '2025-05-05', 'ACTIVE'),
('PRM036', '618全民购物节', '折扣', 0.70, '2025-06-01', '2025-06-18', 'ACTIVE'),
('PRM037', '暑期嘉年华', '折扣', 0.82, '2025-07-01', '2025-08-31', 'ACTIVE'),
('PRM038', '中秋佳节', '赠品', NULL, '2025-09-20', '2025-09-29', 'ACTIVE'),
('PRM039', '十一国庆盛典', '满减', NULL, '2025-10-01', '2025-10-07', 'ACTIVE'),
('PRM040', '双11超级购物节', '折扣', 0.65, '2025-11-01', '2025-11-11', 'ACTIVE'),
('PRM041', '双12年度收官', '折扣', 0.68, '2025-12-01', '2025-12-12', 'ACTIVE'),
('PRM042', '品牌日-智能家电', '折扣', 0.80, '2025-04-20', '2025-04-22', 'ACTIVE'),
('PRM043', '限时特惠', '折扣', 0.60, '2025-01-01', '2025-12-31', 'ACTIVE'),
('PRM044', '会员尊享月', '折扣', 0.85, '2025-01-01', '2025-12-31', 'ACTIVE'),
...
BEGIN
    FOR i IN 1..5000 LOOP
        -- 随机日期 (2022-2025)
        v_rand_date := '2022-01-01'::DATE + (RANDOM() * 1461)::INT;
        ...
        v_sales_team_key := 1 + FLOOR(RANDOM() * 5)::INT;
        v_channel_key := 1 + (RANDOM() * 9)::INT;
        v_promotion_key := CASE WHEN RANDOM() < 0.3 THEN 1 + (RANDOM() * 44)::INT ELSE 1 END;
