...
```xml
<properties>
    <foggy-model.version>8.1.7.beta</foggy-model.version>
</properties>
```
...
[x] 版本属性 foggy-model.version = 8.1.7.beta
...
- 使用 Maven 属性管理版本：`<foggy-model.version>8.1.7.beta</foggy-model.version>`
