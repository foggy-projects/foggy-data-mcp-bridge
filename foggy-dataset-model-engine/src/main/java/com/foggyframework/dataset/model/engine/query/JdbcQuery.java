...
import com.foggyframework.dataset.model.engine.formula.JdbcLink;
...
import com.foggyframework.dataset.model.engine.query_model.ColumnRefResolver;
...
import com.foggyframework.dataset.model.proxy.JoinBuilderFunction;
...
public class JdbcQuery {
    ...
    private void joinReferencedColumnsForOrder(DbColumn selectColumn) {
        if (selectColumn instanceof com.foggyframework.dataset.model.spi.support.CalculatedDbColumn calcColumn) {
