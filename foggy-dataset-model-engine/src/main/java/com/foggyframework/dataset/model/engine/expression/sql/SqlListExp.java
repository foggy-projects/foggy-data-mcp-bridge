 ...
 * 的多参数形态）。由 {@link com.foggyframework.dataset.model.engine.expression.SqlExpFactory}
 * 在 {@code createSqlExp("()", args)} 检测到 args.size() &gt;= 2 时生成。</p>
 *
 * <p>空列表 {@code ()} 在 {@link com.foggyframework.dataset.model.engine.expression.SqlExpFactory}
