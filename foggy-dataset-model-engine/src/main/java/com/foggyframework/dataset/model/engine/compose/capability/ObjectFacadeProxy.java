...
public final class ObjectFacadeProxy {
    ...
    private Object executeWithTimeout(MethodDescriptor methodDesc, Object[] args) {
        ...
        com.foggyframework.dataset.model.engine.compose.runtime.ScriptRunContext
                parentRunCtx = com.foggyframework.dataset.model.engine.compose.runtime
                .ScriptRunContextHolder.current();
        // P2.5-fix: also capture the SuspensionManager for child thread
        com.foggyframework.dataset.model.engine.compose.runtime.SuspensionManager
                parentManager = com.foggyframework.dataset.model.engine.compose.runtime
        ...
        try {
            Future<Object> future = executor.submit(() -> {
                ...
                com.foggyframework.dataset.model.engine.compose.runtime.ScriptRunContextHolder.Token
                        ctxToken = null;
                if (parentRunCtx != null) {
                    ctxToken = com.foggyframework.dataset.model.engine.compose.runtime
                            .ScriptRunContextHolder.set(parentRunCtx);
                }
                // P2.5-fix: propagate manager to child thread
                if (parentManager != null) {
                    com.foggyframework.dataset.model.engine.compose.runtime
            ...
            try {
                ...
                if (cause instanceof com.foggyframework.dataset.model.engine.compose.runtime
