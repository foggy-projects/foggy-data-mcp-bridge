...
import com.foggyframework.dataset.model.engine.compose.plan.AggregateColumn;
...
import com.foggyframework.dataset.model.engine.compose.plan.OverClause;
import com.foggyframework.dataset.model.engine.compose.plan.PlanColumnRef;
import com.foggyframework.dataset.model.engine.compose.plan.ProjectedColumn;
...
import com.foggyframework.dataset.model.engine.compose.plan.WindowColumn;
import com.foggyframework.dataset.model.engine.compose.plan.expr.BinaryExpr;
import com.foggyframework.dataset.model.engine.compose.plan.expr.CaseWhenExpr;
...
import com.foggyframework.dataset.model.engine.compose.plan.expr.RawExpr;
...
import com.foggyframework.dataset.model.engine.compose.schema.SchemaDerivation;
 ...
 * SQL emission, only when {@link com.foggyframework.dataset.model.engine.compose.ComposeFeatureFlags#g10Enabled()}
