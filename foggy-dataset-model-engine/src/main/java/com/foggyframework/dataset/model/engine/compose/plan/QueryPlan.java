...
import com.foggyframework.dataset.model.engine.compose.compilation.ComposeSqlCompiler;
...
import com.foggyframework.dataset.model.engine.compose.runtime.PlanExecution;
...
public abstract class QueryPlan implements PropertyHolder, PropertyFunction {
     ...
     * com.foggyframework.dataset.model.engine.compose.runtime.ComposeRuntimeBundle}.
     *
     * <p>M7 wiring: reads the bundle from
     * {@link com.foggyframework.dataset.model.engine.compose.runtime.ComposeRuntimeHolder#currentBundle()},
     * then delegates to
     * {@link com.foggyframework.dataset.model.engine.compose.runtime.PlanExecution#executePlan}.</p>
     *
     ...
     *  non-empty {@link String} or any {@link com.foggyframework.dataset.model.engine.compose.plan.expr.PlanExpression}.
    ...
    static void validateColumnElements(List<?> columns, String fieldName) {
        ...
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (c instanceof com.foggyframework.dataset.model.engine.compose.plan.expr.PlanExpression) {
                continue;
            }
            throw new IllegalArgumentException(
