...
import com.foggyframework.dataset.model.engine.expression.CalculateExpressionAnalyzer;
...
public final class TimeWindowValidator {
    ...
    public static String validateCalculatedFieldInteraction(
            ...
            java.util.List<com.foggyframework.dataset.model.def.query.request.CalculatedFieldDef> calculatedFields,
