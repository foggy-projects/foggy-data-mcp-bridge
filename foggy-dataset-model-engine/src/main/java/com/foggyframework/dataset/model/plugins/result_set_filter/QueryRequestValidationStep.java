...
public class QueryRequestValidationStep implements DataSetResultStep {
     ...
     * <ul>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.HierarchyOperator}</li>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.ChildrenOfOperator}</li>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.DescendantsOfOperator}</li>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.SelfAndDescendantsOfOperator}</li>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.AncestorsOfOperator}</li>
     *   <li>{@link com.foggyframework.dataset.model.engine.formula.hierarchy.SelfAndAncestorsOfOperator}</li>
