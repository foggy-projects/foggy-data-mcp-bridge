        ...
        if (queryModel instanceof QueryModelSupport) {
            ...
            if (aliasCollision != null) {
                ...
                for (TableModel tm : qms.getJdbcModelList()) {
                    com.foggyframework.dataset.model.spi.DbMeasure measure = tm.findJdbcMeasureByName(aliasName);
                    if (measure != null) {
                        com.foggyframework.dataset.model.impl.measure.DbMeasureSupport ms =
                                measure.getDecorate(com.foggyframework.dataset.model.impl.measure.DbMeasureSupport.class);
