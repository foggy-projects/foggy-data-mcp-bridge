...
class TimeWindowValidatorTest {
    ...
    class CalculatedFieldInteraction {
        ...
        void targetMetricsRejectsCalculatedField() {
            ...
            var calcField = new com.foggyframework.dataset.model.def.query.request.CalculatedFieldDef(
        ...
        void postCalcFieldDependencyRejected() {
            ...
            var growthPercent = new com.foggyframework.dataset.model.def.query.request.CalculatedFieldDef(
                    "growthPercent", "salesAmount__ratio * 100");
            var growthPercentTwice = new com.foggyframework.dataset.model.def.query.request.CalculatedFieldDef(
