...
import com.foggyframework.dataset.model.plugins.result_set_filter.SyntheticMemberInternalPatchStep;
...
class SyntheticMemberPermissionIT extends EcommerceTestSupport {
    ...
    // ==================== AdvancedQueryFacade 链路验证 ====================

    @Nested
    @DisplayName("AdvancedQueryFacade 链路")
