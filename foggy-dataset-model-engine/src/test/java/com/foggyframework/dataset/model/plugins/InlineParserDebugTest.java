...
class InlineParserDebugTest {
    ...
    void testParseInlineExpression() {
        String expr1 = "sum(amount) as sumTotalAmount";
        InlineExpressionParser.InlineExpression result1 = InlineExpressionParser.parse(expr1);
        
        System.out.println("Input: " + expr1);
        System.out.println("Result: " + result1);
        
        assertNotNull(result1, "Should recognize 'sum(amount) as sumTotalAmount' as inline expression");
        assertEquals("sum(amount)", result1.getExpression());
