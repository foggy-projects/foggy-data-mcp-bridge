...
class CatalogRefreshCoordinatorContractTest {
    ...
    private static final String REFRESH =
            "com.foggyframework.dataset.model.lifecycle.refresh.";
    ...
    void refreshRequestAndResultMustCarryTheCompletePinnedInputAndOutcome() {
        assertRecordComponents(
                ...
                component("targets", "java.util.Set<com.foggyframework.dataset.model.lifecycle.catalog.CatalogModelKey>"),
        ...
        assertRecordComponents(
                ...
                component("namespace", "java.lang.String"),
                component("scope", REFRESH + "CatalogRefreshScope"),
                component("beforeIdentity", "com.foggyframework.dataset.model.lifecycle.identity.CatalogIdentity"),
                component("afterIdentity", "com.foggyframework.dataset.model.lifecycle.identity.CatalogIdentity"),
                component("sourceRevision", "com.foggyframework.dataset.model.lifecycle.identity.SourceRevision"),
                component("refreshedModels", "java.util.Set<com.foggyframework.dataset.model.lifecycle.catalog.CatalogModelKey>"),
                component("preservedModels", "java.util.Set<com.foggyframework.dataset.model.lifecycle.catalog.CatalogModelKey>"),
                component("affectedBindings", "java.util.List<com.foggyframework.dataset.model.lifecycle.identity.DatasourceBindingIdentity>"),
                component("durationMs", "long"),
                component("catalogState", "com.foggyframework.dataset.model.lifecycle.catalog.CatalogAdmissionState"),
                component("diagnostics", "java.util.List<com.foggyframework.dataset.model.lifecycle.refresh.CatalogRefreshDiagnostic>")
        );
    }
